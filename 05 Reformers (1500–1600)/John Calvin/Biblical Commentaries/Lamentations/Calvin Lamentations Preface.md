...
The Greek Translators call this Book Θρήνους, Lamentations, and very properly, as also the Hebrews call it קינוה, *kinut*; though the common name or title is אכה, *aike*, from the first word in it. But when they wish to express what the Book contains, they call it קינות, *kinut*, Lamentations.

Let us now proceed to the words; for what I have now briefly touched upon, can be more fully explained as we go on.

---
[[Library/protestant reformers/John Calvin/Biblical Commentaries/Lamentations/lamentations-index|Contents]] · [[Calvin Lamentations 1|Lamentations 1 →]]

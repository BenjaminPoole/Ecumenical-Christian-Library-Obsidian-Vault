...
work: "Didache"
written: "c. 50–120 AD"
earliest_ms: "1056 AD (Codex Hierosolymitanus)"
year: "1886"
source: "Roberts-Donaldson translation (Ante-Nicene Fathers, 1886); manuscript image and background from Wikipedia"
tags:
  - didache
  - church-fathers
  - apostolic-fathers
...
![[Didache.png]]
*Manuscript of the Didache — the Codex Hierosolymitanus (Jerusalem Codex), copied in 1056 by the scribe Leo. This eleventh-century codex, discovered in Constantinople in 1873 by Metropolitan Philotheos Bryennios, is the only complete Greek witness to the text. (Image via Wikipedia, public domain.)*

The *Didache* (Greek Διδαχή, "Teaching"), or *The Teaching of the Twelve Apostles*, is a brief early Christian treatise generally dated to the late first or early second century. Lost for centuries and known only by reputation, it was rediscovered in 1873 and first published by Bryennios in 1883. It falls into four parts: a moral catechism built on the contrast of "two ways" (chapters 1–6); instructions on baptism, fasting, prayer, and the Eucharist (7–10); rules for receiving apostles, prophets, and teachers and for appointing bishops and deacons (11–15); and a closing exhortation to watchfulness in view of the Lord's coming (16).

The text below follows the public-domain Roberts-Donaldson English translation, as printed in the *Ante-Nicene Fathers*. Manuscript image and historical background are drawn from Wikipedia.


## The Two Ways

*Chapters 1–6 — moral instruction*
...
## Instructions on Church Practice

*Chapters 7–10 — baptism, fasting, prayer, and the Eucharist*
...
*Chapters 11–15 — apostles, prophets, teachers, bishops, and deacons*
...
*Chapter 16 — watchfulness and the last days*
